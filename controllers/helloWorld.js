...
const runMyContract = (req, res) => {
  ...
  const contractAddress = "0x400Ec67f3E50247E0b28b044a29940EF1B35F872"
  const myContract = new web3.eth.Contract(contractABI, contractAddress);

  const fromAccount = "0x8B09D28deF4dEea3184CDba911d45de5a1e86874";
  const functionCall = myContract.methods.safeMint("0x41150B3a6b82bBb202a951d20D45F50005B2016E");

  functionCall.send({ from: fromAccount}).on("transactionHash", (hash) => {
...
module.exports = {sayHello, runMyContract}